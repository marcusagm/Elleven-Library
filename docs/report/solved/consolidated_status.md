...
*   [x] **Extração de Assets de Design (.ai, .eps):**
...
### Ingestão Avançada
*   [x] **Web Clipper / Extensão de Navegador:** (Planejado em `features.md`)
*   [x] **Integração com Clipboard:** Colar imagens (Ctrl+V) diretamente na biblioteca.
*   [x] **Deep OS Integration:** Atalhos globais para screenshot.
