...
export const useLibrary = () => {
    return {
        ...
        toggleItemFavorite: libraryActions.toggleItemFavorite,
        moveToTrashAssets: libraryActions.moveToTrashAssets,
        restoreFromTrashAssets: libraryActions.restoreFromTrashAssets,
