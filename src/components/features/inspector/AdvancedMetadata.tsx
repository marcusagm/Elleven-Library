...
export const AdvancedMetadata: Component<AdvancedMetadataProps> = (props) => {
    ...
    return (
        <AccordionItem 
            ...
            icon={<List size={14} />}
        >
            <Show when={!exif.loading} fallback={
                <div class="inspector-loading-overlay" style="height: 60px;">
                    <Loader2 class="animate-spin" size={20} />
                </div>
            }>
                <div class="inspector-field-group">
                    <Show when={Object.keys(exif() || {}).length > 0} fallback={
                        <div class="inspector-batch-info">No EXIF data found.</div>
                    }>
                            ...
                            <For each={Object.entries(exif() || {})}>
                                {([key, value]) => (
                                    <div class="inspector-meta-item">
                                        ...
                                        <span class="inspector-meta-value" style="word-break: break-all;">
                                            {value}
                                        </span>
                                    </div>
                                )}
