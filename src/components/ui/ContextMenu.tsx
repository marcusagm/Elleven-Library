import { Component, For, Show, createSignal, createEffect, onCleanup, JSX } from 'solid-js';
...
const SubmenuWrapper: Component<{ children: JSX.Element }> = props => {
    ...
    return (
        <div ref={ref} class="ui-context-submenu" role="menu">
            {props.children}
        </div>
    );
};
                ...
                {(item, index) => (
                    ...
                    >
                        ...
                        <Show when={item.type === 'custom'}>
                            <div class="ui-context-menu-custom">{(item as any).content}</div>
                        </Show>
                        ...
                        <Show when={item.type === 'submenu'}>
                            {(() => {
                                const submenuItem = item as Extract<
                                    ContextMenuItem,
                                    { type: 'submenu' }
                                >;
                                return (
