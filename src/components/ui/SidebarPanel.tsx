...
export const SidebarPanel: Component<SidebarPanelProps> = props => {
    ...
    return (
        <section class={cn('ui-sidebar-panel', local.class)} aria-label={local.title} {...others}>
            ...
            <div class={cn('ui-sidebar-panel-content', local.contentClass)}>{local.children}</div>

            <Show when={local.footer}>
                <footer class="ui-sidebar-panel-footer">{local.footer}</footer>
            </Show>
        </section>
    );
};
