...
function hexToHsb(hex: string): { h: number; s: number; b: number } {
    ...
    const hue =
        n === 0 ? 0 : v === r ? (g - bVal) / n : v === g ? 2 + (bVal - r) / n : 4 + (r - g) / n;
...
export const ColorPicker: Component<ColorPickerProps> = props => {
    ...
    return (
        <div class={cn('ui-color-picker', local.class)} onClick={e => e.stopPropagation()}>
            ...
            {showInput() && (
                <div class="ui-color-picker-controls">
                    <div
                        ...
                        style={{
                            'background-color':
                                local.color === 'transparent' ? 'transparent' : local.color,
                            'background-image':
                ...
                <For each={presets()}>
                    {color => (
                        <button
                            ...
                            class={cn(
                                'ui-color-picker-preset',
                                local.color.toLowerCase() === color.toLowerCase() &&
