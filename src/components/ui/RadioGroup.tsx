import { Component, JSX, splitProps, createContext, useContext, createMemo, Show } from 'solid-js';
...
export const RadioGroupItem: Component<RadioGroupItemProps> = props => {
    ...
    return (
        <label
            class={cn('ui-radio-wrapper', isDisabled() && 'ui-radio-disabled', local.class)}
            for={id()}
        >
            <button
                type="button"
            ...
            {(local.label || local.description) && (
                <div class="ui-radio-content">
                    <Show when={local.label}>
                        <span class={cn('ui-radio-label', `ui-radio-label-${local.size || 'md'}`)}>
                            {local.label}
                        </span>
                    </Show>
                    <Show when={local.description}>
                        <span
                            ...
                            class={cn(
                                ...
                                `ui-radio-description-${local.size || 'md'}`
                            )}
                        >
                            {local.description}
                        </span>
