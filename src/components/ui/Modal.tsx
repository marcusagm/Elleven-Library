...
export const Modal: Component<ModalProps> = props => {
    ...
    return (
        <Show when={local.isOpen}>
            <Portal>
                <div class="ui-modal-overlay" onClick={handleOverlayClick} aria-hidden="true" />
                <div
                    ref={containerRef}
                    class={cn('ui-modal-container', `ui-modal-${size()}`, local.class)}
                    role="dialog"
                    aria-modal="true"
                ...
                >
                    ...
                    <div class="ui-modal-body">{local.children}</div>

                    <Show when={local.footer}>
                        <footer class="ui-modal-footer">{local.footer}</footer>
                    </Show>
                </div>
            </Portal>
        </Show>
