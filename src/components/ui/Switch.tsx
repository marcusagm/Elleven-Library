...
export const Switch: Component<SwitchProps> = props => {
    ...
    return (
        <label
            class={cn('ui-switch-wrapper', local.disabled && 'ui-switch-disabled', local.class)}
            for={id()}
        >
            <button
                type="button"
            ...
            <Show when={local.label || local.description}>
                <div class="ui-switch-content">
                    <Show when={local.label}>
                        <span
                            class={cn('ui-switch-label', `ui-switch-label-${local.size || 'md'}`)}
                        >
                            {local.label}
                        </span>
                    </Show>
                    <Show when={local.description}>
                        <span
                            ...
                            class={cn(
                                ...
                                `ui-switch-description-${local.size || 'md'}`
                            )}
                        >
                            {local.description}
                        </span>
