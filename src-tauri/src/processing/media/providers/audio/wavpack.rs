...
/// Provider for WavPack Audio files (.wv).
///
/// WavPack is a completely open audio compression format providing lossless,
/// high-quality lossy, and a unique hybrid compression mode. Requires Audio HLS
...
///
/// ```no_run
/// use mundam_lib::processing::media::providers::audio::wavpack::WavpackAudioProvider;
///
/// let provider = WavpackAudioProvider::new();
/// let formats = provider.supported_formats();
/// ```
#[derive(Default)]
pub struct WavpackAudioProvider;

impl WavpackAudioProvider {
    /// Creates a new instance of `WavpackAudioProvider`.
    ///
    /// # Returns
    ///
    /// `WavpackAudioProvider` - A new instance of the provider.
    pub fn new() -> Self {
        Self
    }
}

impl FormatProvider for WavpackAudioProvider {
...
#[async_trait]
impl MetadataCapability for WavpackAudioProvider {
