...
/// Provider for DTS Audio files (.dts).
///
/// Digital Theater Systems audio codec. Widely used in DVDs and Blu-rays.
...
///
/// ```no_run
/// use mundam_lib::processing::media::providers::audio::dts::DtsAudioProvider;
///
/// let provider = DtsAudioProvider::new();
/// let formats = provider.supported_formats();
/// ```
#[derive(Default)]
pub struct DtsAudioProvider;

impl DtsAudioProvider {
    /// Creates a new instance of `DtsAudioProvider`.
    ///
    /// # Returns
    ///
    /// `DtsAudioProvider` - A new instance of the provider.
    pub fn new() -> Self {
        Self
    }
}

impl FormatProvider for DtsAudioProvider {
...
#[async_trait]
impl MetadataCapability for DtsAudioProvider {
