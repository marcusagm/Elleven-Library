...
/// Provider for Windows Media Audio files (.wma).
///
/// Proprietary audio format from Microsoft. Requires transcoding via Audio HLS
...
///
/// ```no_run
/// use mundam_lib::processing::media::providers::audio::windows_media_audio::WindowsMediaAudioProvider;
///
/// let provider = WindowsMediaAudioProvider::new();
/// let formats = provider.supported_formats();
/// ```
#[derive(Default)]
pub struct WindowsMediaAudioProvider;

impl WindowsMediaAudioProvider {
    /// Creates a new instance of `WindowsMediaAudioProvider`.
    ///
    /// # Returns
    ///
    /// `WindowsMediaAudioProvider` - A new instance of the provider.
    pub fn new() -> Self {
        Self
    }
}

impl FormatProvider for WindowsMediaAudioProvider {
...
#[async_trait]
impl MetadataCapability for WindowsMediaAudioProvider {
