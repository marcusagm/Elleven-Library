...
/// Provider for Musepack Audio files (.mpc).
///
/// Musepack is an open source audio compression format specifically optimized
/// for transparent encoding of stereo audio at mid-high bitrates.
/// Transcoded via Audio HLS for browser playback.
///
/// # Technical Details
///
...
///
/// ```no_run
/// use mundam_lib::processing::media::providers::audio::musepack::MusepackAudioProvider;
///
/// let provider = MusepackAudioProvider::new();
/// let formats = provider.supported_formats();
/// ```
#[derive(Default)]
pub struct MusepackAudioProvider;

impl MusepackAudioProvider {
    /// Creates a new instance of `MusepackAudioProvider`.
    ///
    /// # Returns
    ///
    /// `MusepackAudioProvider` - A new instance of the provider.
    pub fn new() -> Self {
        Self
    }
}

impl FormatProvider for MusepackAudioProvider {
...
#[async_trait]
impl MetadataCapability for MusepackAudioProvider {
