...
/// Provider for AMR Audio files (.amr).
///
/// Adaptive Multi-Rate audio codec. Used widely in mobile telecommunications for speech.
/// Requires transcoding via Audio HLS for browser playback.
///
/// # Technical Details
///
...
///
/// ```no_run
/// use mundam_lib::processing::media::providers::audio::amr::AmrAudioProvider;
///
/// let provider = AmrAudioProvider::new();
/// let formats = provider.supported_formats();
/// ```
#[derive(Default)]
pub struct AmrAudioProvider;

impl AmrAudioProvider {
    /// Creates a new instance of `AmrAudioProvider`.
    ///
    /// # Returns
    ///
    /// `AmrAudioProvider` - A new instance of the provider.
    pub fn new() -> Self {
        Self
    }
}

impl FormatProvider for AmrAudioProvider {
...
#[async_trait]
impl MetadataCapability for AmrAudioProvider {
