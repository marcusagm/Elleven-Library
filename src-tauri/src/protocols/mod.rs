...
pub fn register_all<R: tauri::Runtime>(builder: tauri::Builder<R>) -> tauri::Builder<R> {
    builder
        ...
        .register_uri_scheme_protocol("audio", move |_ctx, request| audio::handler(&request))
        .register_uri_scheme_protocol("video", move |_ctx, request| video::handler(&request))
        ...
        .register_uri_scheme_protocol("font", move |_ctx, request| font::handler(&request))
        .register_uri_scheme_protocol("model", move |_ctx, request| model::handler(&request))
